...
void *handle_game(void *arg)
{
    ...
    struct sockaddr_in *clientAddrs = args->clientAddrs;
    ...
    free(arg); // Liberar la memoria de los argumentos
    return NULL;
}
...
int main(int argc, char *argv[])
{
    ...
    log_info("Esperando a que se conecten los clientes...");
    ...
    while (1)
    {
        ...
        // Creando un nuevo hilo para manejar el juego de este par de clientes.
        pthread_t game_thread;
        GameThreadArgs *args = malloc(sizeof(GameThreadArgs));
        args->clientAddrs = clientAddrs;
        args->sockfd = sockfd;
        pthread_create(&game_thread, NULL, handle_game, (void *)args);

        // Puedes desvincular el hilo para que cuando termine, sus recursos sean liberados automáticamente.
